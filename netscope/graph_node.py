...
class GraphNode:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "inputs", tuple(str(item).strip() for item in self.inputs))
        object.__setattr__(self, "outputs", tuple(str(item).strip() for item in self.outputs))
