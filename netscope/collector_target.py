...
class CollectorTarget:
    """
    Immutable collector target descriptor.
    """
    ...
    def from_object(
        ...
        *,
        ...
        """
        Build a collector target descriptor from an arbitrary object.
        """
    ...
    def with_metadata(self, **kwargs: Any) -> CollectorTarget:
